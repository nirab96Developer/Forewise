  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'ציוד ומלאי כלים',
        description: 'כלים של ספקים, מספרי רישוי, תעריפים',
        icon: <Wrench className="w-5 h-5" />,
        path: '/settings/suppliers?tab=equipment',
      },
      {
        id: 'supplier-pricing',
        title: 'תמחור',
        description: 'תעריפי שעה, לילה וסופ"ש לפי ספק',
        icon: <DollarSign className="w-5 h-5" />,
        path: '/settings/suppliers?tab=pricing',
      },
    ],
  },
  {
