          ...
          <div>
            ...
            {selSupplier && (
              <div className="flex items-center gap-3 bg-gray-50 rounded-xl border border-gray-200 px-3 py-2.5 mt-2">
                <div className="w-8 h-8 rounded-full bg-green-100 text-fw-green text-xs font-bold flex items-center justify-center flex-shrink-0">{selSupplier.name[0]}</div>
                <div>
...
{selType?.hourly_rate && <div className="text-xs text-fw-green mt-1 font-medium">ברירת מחדל: {selType.hourly_rate}/שעה</div>}
            </div>
            <div>
              ...
              <input value={form.license_plate} onChange={e=>f('license_plate',e.target.value)} placeholder="12-345-67"
                className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm font-mono text-gray-800 placeholder-gray-400 focus:outline-none focus:border-fw-green focus:ring-1 focus:ring-fw-green" />
